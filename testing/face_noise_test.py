...
def main(user):
    ...
    if (known_face_encodings and face_encodings):
        print("Saved encoding: " + str(known_face_encodings[0]))
        print("Attempt encoding: " + str(face_encodings[0]))
        print(str(face_distances))
