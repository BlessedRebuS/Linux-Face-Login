...
def gpgme_op_receive_keys_start(ctx: "gpgme_ctx_t", keyids: "char const *[]") -> "gpgme_error_t":
    r"""gpgme_op_receive_keys_start(ctx, keyids) -> gpgme_error_t"""
    return _gpgme.gpgme_op_receive_keys_start(ctx, keyids)

def gpgme_op_receive_keys(ctx: "gpgme_ctx_t", keyids: "char const *[]") -> "gpgme_error_t":
